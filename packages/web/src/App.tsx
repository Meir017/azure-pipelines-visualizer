...
import ApprovalGatesPage from './components/approval-gates/ApprovalGatesPage.js';
...
type AppView = 'pipeline' | 'commit-flow' | 'approvals';
      ...
      <div className="app">
        <header className="app__header">
          ...
          <nav className="app__nav">
            ...
            <button
              className={`app__nav-btn ${view === 'approvals' ? 'app__nav-btn--active' : ''}`}
